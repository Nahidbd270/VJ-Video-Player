...
ADMIN = int(environ.get('ADMIN', '8172129114 5370676246'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002869675678'))
...
LINK_URL = environ.get("LINK_URL", "https://ctgmovies247.blogspot.com/p/ctg-movie.html")
